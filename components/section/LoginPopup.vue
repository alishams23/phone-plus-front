            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                ...
                <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                    ...
                    <!-- Your content -->
                                ...
                                <div class="space-y-6" >
                                    <div class="ltr">
                                        ...
                                        <div class="relative mt-2 rounded-full shadow-sm">
                                            <input type="text" name="phone-number" id="phone-number" v-model="phoneNumber" class="block w-full rounded-full border-0 py-1.5 pl-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 " placeholder="09 -- -- -- -- -- -- -- " />
                            ...
                            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                                <form class="space-y-6" action="#" method="POST">
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                        <input type="text" name="first-name" id="first-name" v-model="first_name" autocomplete="given-name" class="block w-full rounded-full border-0 py-1.5 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 " />
                                        </div>
                                    </div>
                                    ...
                                    <div class="sm:col-span-3">
                                        ...
                                        <div class="mt-2">
                                        <input type="text" name="last-name" id="last-name" v-model="last_name" autocomplete="family-name" class="block w-full rounded-full border-0 py-1.5 pr-3 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 " />
                                        </div>
                                    </div>
                        ...
                        <div v-if="dialog_page == 'get_code_signup'" class="flex min-h-full flex-1 flex-col justify-center px-6 py-5 lg:px-8">
                           {{ token }}
                            <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                                <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">کد را وارد کنید</h2>
                            </div>
