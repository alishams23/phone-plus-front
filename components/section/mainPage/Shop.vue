      ...
      <a :href="'/' + item.username" target="blank" >
        <div class="w-full max-w-xl px-5  ">
          ...
          <div class="  flex flex-col items-center pb-5">
            ...
            <!-- <BuildingStorefrontIcon v-else class=" w-8 h-8 md:w-24 md:h-24 backdrop-grayscale -mt-10   mb-3 rounded-3xl p-3 object-cover shadow-3" /> -->
            <h5 class="mb-1 text-md font-medium text-gray-900 w-[100px] text-center " style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">{{ item.name }}</h5>
...
export default{
    components: { ShoppingBagIcon, BuildingStorefrontIcon }, 
    data(){
        return{
            shops:[],
            loading:true,
