<template>
    <div   class=" ">
      <div class="  relative ">
        ...
        <div data-aos="flip-up" class="mx-5 lg:mx-auto max-w-2xl py-32 sm:py-48 lg:pb-[7rem] lg:pt-[4rem]">
                ...
                <div class="absolute  mt-2 w-full" v-show="searchQuery != null && searchQuery != ''"
                  ...
                  <ul class="bg-gray-100 rtl rounded-xl  shadow-xl w-full">
                    ...
                    <Swiper :modules="modules" :slides-per-view="'auto'" :loop="false" :space-between="20">
                      <SwiperSlide v-for="item in products" :key="item" class="mb-10 px-2">
                        <div class="rtl">
                    ...
                    <Swiper :modules="modules" :slides-per-view="'auto'" :loop="false" :space-between="20">
                      <SwiperSlide v-for="item in digital_products" :key="item" class="mb-10 px-2">
                        <div class="rtl">
                          <div class="flex items-start border  rounded-xl text-sm overflow-hidden">
                            <div class="px-5 py-3 flex-grow ">
                              <div class="">
