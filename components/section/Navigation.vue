<template>
    <div class="fixed bottom-0 left-0 z-50 grid w-full h-16 grid-cols-1 px-8   border-gray-200 md:grid-cols-3 ">
        <div class="items-center bg-glass-3 rounded-full px-8 justify-center hidden mr-auto text-gray-500 dark:text-gray-400 md:flex">
        ...
        <div class="flex items-center bg-glass px-8 rounded-full justify-center mx-auto">
        ...
        <div class=" bg-glass-3 px-8 rounded-full items-center justify-center hidden ml-auto md:flex">
