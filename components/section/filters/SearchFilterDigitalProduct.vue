...
props:['text','page'],
  ...
  methods: {
    ...
    getCategories() {
      this.loading = true
      axios.get(`http://192.168.1.109:8000/api/product/list-digital-categories/?search=${this.text_search_categories}&is_main_page=${this.text_search_categories == null ?true:''}`, {
        headers: {
          "Content-type": "application/json",
          Accept: "application/json",
        },
