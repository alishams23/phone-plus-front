<template>
    ...
    <div :class="width ? `${width}` : 'w-[15rem]'" class="relative isolate my-10 mx-2 justify-end overflow-hidden rounded-[25px]  bg-gray-900 px-8 pb-8 pt-60 sm:pt-60 lg:pt-60">
