          ...
          <div class="grid grid-cols-1 gap-4 lg:col-span-2">
            <div>
              <div class="hidden sm:block">
                <nav class="cursor-pointer isolate flex divide-x divide-gray-200 rounded-lg shadow" aria-label="Tabs">
                ...
                <div class="p-6">
                  ...
                  <div v-if="selected_tab == 0">
                    ...
                    <div class="flex m-4 justify-center mt-10" v-if="false">
                      ...
                      <a href="#" class="flex items-center justify-center  px-5 h-9 text-sm font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 ">
                        بعدی
