...
<template>
    ...
    <div class="min-h-full">
        <main class=" pb-8">
            <div class="mx-auto max-w-full  lg:max-w-full lg:px-8">
            <h1 class="sr-only">Page title</h1>
                <section aria-labelledby="section-1-title">
                    ...
                    <div class="">
                        ...
                        <div class="text-gray-800 font-bold text-xl text-right p-4">
                            محصولات پین شده 
                        </div>
                        ...
                        <div class="text-gray-800 font-bold text-xl text-right p-4">
                          ...
                          <div class="   isolate overflow-hidden relative mb-10">
                            <Carousel  :itemsToShow="1.4" :wrapAround="true" :transition="500" class="pt-5 pb-24">
