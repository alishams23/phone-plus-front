                    ...
                    <div class="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0 rtl">
                      ...
                      <div class="mt-3">
                        ...
                        <div v-if="product.discount != 0 "  class="flex items-center ">
                          <div class="text-xl line-through text-gray-300  tracking-tight">{{ product.price + selected_color.price }} </div>
                          <div class=" overflow-hidden rounded-lg p-4">
                              <div class=" text-red-700 shadow-xl text-sm font-semibold bg-glass-red rtl text-right rounded-full px-3 py-1" v-if="product.discount != 0">   {{product.discount}} % </div>
                          </div>
                        </div> 
                        <p class="text-3xl tracking-tight text-gray-900">{{ (product.price + selected_color.price)*((100-product.discount)/100) }} <span class="text-sm text-gray-600">تومان</span></p>
                      </div>
                                ...
                                <div class="mt-6 border-t border-gray-100">
                                  <dl class="divide-y divide-gray-100">
                                    <div v-for="item in product.Specification" :key="item.id"
                                      ...
                                      <dd class="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">{{ item.body }}
                                      </dd>
                                    </div>
                        ...
                        <div class="flex items-center">
                         <div class="h-10 w-10 flex justify-center items-center p-1 me-2 rounded-full bg-gray-100">
                          ...
                          <div class="text-sm leading-6">
                            <div class="font-semibold text-gray-600">{{comment.author.first_name}} {{ comment.author.last_name }}</div>
                            <div class="">
                              <h3 class="sr-only">Reviews</h3>
                              <div class="flex items-center">
                                <div class="flex items-center">
...
export default {
  ...
  methods: {
    getData() {
      this.loading = true
      axios.get(`http://192.168.157.128:8000/api/product/product-retrieve-main-page/${this.$route.params.id}/`, {
        headers: {
