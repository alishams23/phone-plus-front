    ...
    <div class="flex flex-col justify-center items-center " v-if="results">
      <div>
        <ul class="absolute left-10 flex justify-start mt-5 space-x-5">
            ...
            <li class="bg-glass-3 rounded-full  ps-2 pt-2 pb-2 pe-2 flex justify-center items-center">
                <a href="https://www.instagram.com/yourprofile" target="_blank" class="text-indigo-300 hover:text-gray-500 ">
            ...
            <li class="bg-glass-3 rounded-full  ps-2 pt-2 pb-2 pe-2 flex justify-center items-center">
                <a href="https://x.com/yourprofile" target="_blank" class="text-indigo-300 hover:text-gray-500 ">
                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
