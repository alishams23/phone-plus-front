        ...
        <div class=" shadow-lg -mt-32 pb-10 flex justify-center">
            <div class="max-w-[65rem] flex flex-col shadow-lg rounded-[25px] overflow-hidden">
                <div class="flex flex-row">
                    <img :src="blog.imageBlog.photo" :alt="blog.imageBlog.title_for_photo" class="h-[30rem] w-[65rem] rounded-[25px] object-cover" />
                    <div class="absolute bg-gradient-to-r from-gray-500 to-gray-900 opacity-80 rounded-[25px] h-[30rem] w-[65rem]" />
                    <div class="absolute h-[30rem] w-[65rem] ">
                        <h1 class="font-bold rtl px-16 pt-16 text-white text-5xl">
                            {{ blog.title }}
                        </h1>
                        <p class="flex justify-end pt-10 px-24 text-white text-5sm">
                            نویسنده: {{ blog.author.get_full_name }}  
                        </p>
                        <p class="flex justify-end pt-10 px-24 text-white text-sm">
                            {{ blog.created_at }}  
                        </p>
                    </div>
                </div>
